...
import { listAllMessages } from "@/lib/queries/messages";
...
export default async function CommunicationsAdminPage() {
  ...
  const [notifications, messages, talent] = await Promise.all([
    ...
    <div className="flex h-[calc(100dvh-120px)] min-h-[520px] flex-col">
      <div className="pb-4">
        ...
        <p className="mt-1 text-[12.5px] text-muted-foreground">
          Conversations with the roster — chat, availability checks and
